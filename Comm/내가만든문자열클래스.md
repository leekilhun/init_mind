...
namespace t
{
	...
	inline int CStringToLPSTR(CString& str, LPSTR ret_str) {
		...
		int ret = WideCharToMultiByte(CP_ACP, 0, str.GetBuffer(), -1, ret_str, nlen, NULL, NULL);
#else
		int nlen = str.GetLength() + 1;
		ret = strcpy_s(ret_str, nlen, str);
...
#if defined(UNICODE) || defined(_UNICODE)
		int nLen = (int)strlen(str) + 1;
		ret = MultiByteToWideChar(CP_ACP, 0, str, -1, ret_str, nLen * sizeof(TCHAR));
#else
