...
namespace t
{
	...
	/************************************************************************/
	inline LPCTSTR GetStringPoint(CString str) {
		LPTSTR  tchar = {};
		int nlen = str.GetLength() + 1;
		tchar = new TCHAR[nlen];
		memset(tchar, 0x00, nlen * sizeof(TCHAR));
		_tcscpy_s(tchar, nlen, str);
	...
	/// <returns></returns>
	inline char* CStringToChar(CString str) {
		char* szStr = NULL;
	...
	// CString → LPCTSTR
	//
	//inline LPCTSTR CStringToLPCTSTR(CString str) {
	//	LPTSTR tszStr = NULL;
	//	int nLen = str.GetLength() + 1;
	...
	// Char → TCHAR
	//
	inline TCHAR* CharToTCHAR(char* str) {
		TCHAR* tszStr = NULL;
#if defined(UNICODE) || defined(_UNICODE)
		int nLen = (int)strlen(str) + 1;
		tszStr = new TCHAR[nLen];
	...
	// TCHAR → Char
	//
	inline char* TCHARToChar(TCHAR* str) {
		char* szStr = NULL;
#if defined(UNICODE) || defined(_UNICODE)
